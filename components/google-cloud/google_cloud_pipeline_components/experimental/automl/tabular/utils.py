...
def get_distill_skip_evaluation_pipeline_and_parameters(
  ...
  Args:
    batch_predict_machine_type: The prediction server machine type for batch
      predict component in the model distillation.
    batch_predict_starting_replica_count: The initial number of prediction
      server for batch predict component in the model distillation.
  ...
  Returns:
    Tuple of pipeline_definiton_path and parameter_values.
  """
  _, parameter_values = get_skip_evaluation_pipeline_and_parameters(**kwargs)
