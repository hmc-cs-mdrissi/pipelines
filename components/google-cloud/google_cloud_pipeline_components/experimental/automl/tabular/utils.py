...
def get_tab_net_trainer_pipeline_and_parameters(  # pylint:disable=dangerous-default-value
    project: str,
    location: str,
    root_dir: str,
    target_column_name: str,
  ...
  pipeline_definition_path = os.path.join(
      pathlib.Path(__file__).parent.resolve(), 'tab_net_trainer_pipeline.json')
